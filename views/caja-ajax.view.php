    ...
    <script type="text/javascript" src="<?php ECHO RUTA ?>public/js/addons/datatables.min.js"></script>
    <script type="text/javascript" src="<?php ECHO RUTA ?>public/js/addons/dataTables.altEditor.js"></script>
    <style type="text/css">
        .footer-copyright {
            display: none;
        }
