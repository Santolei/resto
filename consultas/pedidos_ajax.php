<?php 
 require '../config/conexion.php';
	...
	foreach ($pedidos as $pedido) {
		echo (
			"<tr>
		      <td scope='row'>" .  "<span class=' font-weight-bold fa-1-2x'>" . $pedido['producto'] . "</span>". "</td>" . 
		      "<td class='print-derecha'>". "<a onClick='" . "restarPedido(" . $pedido['id'] . ")'>" . "<i class='fa fa-minus fa-1-5x text-danger mr-1'> </i>" . "</a>" .  "<span class='font-weight-bold fa-1-2x'>" . $pedido['cantidad'] . "</span>" . " <a class='mas' onClick='" . "sumarPedido(" . $pedido['id']. ")'><i class='fa fa-plus fa-1-5x text-success ml-1'></a>" . "</td>" . 
